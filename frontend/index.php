...
$q_testimoni = mysqli_query($koneksi, "SELECT * FROM testimoni ORDER BY id_testi DESC LIMIT 5");
?>
<!doctype html>
<html lang="id">
  <head>
  ...
  <body>
    ...
    <section class="sambutan scroll-animasi " id="sambutan">
      <div class="container-sambutan">
        <div class="sambutan-main">
          ...
          <p class="sambutan-sbt">TPQ <?=htmlspecialchars($dt_atur['nama_tpq'])?>
</p>

          <div class="text-sambutan">
           <img src="../public/img/profil.jpeg" alt="demn" class="foto-kepala">
        ...
        <div class="sambutan-sidebar">
              ...
              <ul>
                ...
                <li><a href="cek_rapor.php"><i class="fa-solid fa-angle-right"></i> Cek Progres Santri</a></li>
              </ul>
        </div>
      </div>
    </section>
    ...
    <section class="testimoni scroll-animasi" id="testimoni">
      <div class="Utama2">
        ...
        <p>Testimoni dari wali santri yang telah mempercayakan pendidikan Al-Quran putra-putrinya di TPQ <?= htmlspecialchars($dt_atur['nama_tpq']) ?>.</p>
      </div>
      <div class="marquee-container">
        ...
        <?php if($q_testimoni && mysqli_num_rows($q_testimoni) > 0): ?>
          ...
          <!-- Duplikasi untuk Infinite Loop Marquee -->
          <?php mysqli_data_seek($q_testimoni, 0); ?>
          <?php while($row = mysqli_fetch_assoc($q_testimoni)) : ?>
            <div class="testi-modern-card">
              <div class="testi-modern-header">
                <div class="testi-user">
      ...
      <div style="margin-top: 40px; display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
        <a href="testimoni.php" class="btn-ulasan" style="background: #f8fafc; color: #10b981; border: 2px solid #10b981;"><i class="fa-solid fa-list"></i> Lihat Semua Ulasan</a>
    ...
    <section class="galeri-siswa" id="galeri">
      ...
      <div class="gambar-utama">
        ...
        ?>
          <div class="gambarnya">
            <!-- Path gambar dari folder public/img -->
            <img src="../public/img/<?= $dt_galeri['nama_file'] ?>" alt="<?= htmlspecialchars($dt_galeri['keterangan']) ?>">
    ...
    <div id="modalUlasan" class="modal-ulasan">
      <div class="modal-ulasan-content modern-modal animate__animated animate__bounceIn">
        ...
        <div class="modal-ulasan-body">
          <form action="../backend/simpan_ulasan.php" method="POST">
