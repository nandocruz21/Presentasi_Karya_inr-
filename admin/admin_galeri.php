...
if (isset($_POST['simpan'])) {
    ...
    if ($foto['error'] === 4) {
        ...
        if (!in_array($ekstensiGambar, $ekstensiValid)) {
            ...
            $targetPath = '../public/img/' . $namaBaru;
            ...
            if (move_uploaded_file($foto['tmp_name'], $targetPath)) {
                ...
                $msg = "Gagal mengunggah file. Pastikan folder ../public/img/ tersedia.";
                $msg_type = "error";
            }
        }
    }
...
if (isset($_GET['hapus'])) {
    ...
    if ($data) {
        if(file_exists('../public/img/' . $data['nama_file'])) {
            unlink('../public/img/' . $data['nama_file']);
        }
...
<head>
    ...
    <link rel="stylesheet" href="../public/css/admin_galeri.css" />
</head>
<body>
                        ...
                        <?php while($row = mysqli_fetch_assoc($query_galeri)): ?>
                            <div class="kartu-galeri">
                                ...
                                <div class="img-container">
                                    <img src="../public/img/<?= $row['nama_file'] ?>" alt="Dokumentasi">
                                </div>
