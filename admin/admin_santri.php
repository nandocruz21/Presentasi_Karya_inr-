...
<head>
    ...
    <link rel="stylesheet" href="../public/css/admin_santri.css" /> 
...
<body>
                            ...
                            <?php if ($query_santri && mysqli_num_rows($query_santri) > 0): ?>
                                ...
                                <?php while ($data = mysqli_fetch_assoc($query_santri)): ?>
                                    <?php
                                        ...
                                        $path_foto = "../public/uploads/" . $foto_db;
                                    ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="grup-aksi">
                                                ...
                                                <a href="../backend/hapus_santri.php?id=<?= $id_aman ?>" class="aksi-hapus" title="Hapus Data" 
    ...
    <div id="modalBiodata" class="modal-overlay">
        <div class="modal-content">
            ...
            <!-- Area Foto di Modal -->
            <img id="viewFoto" src="../public/uploads/default.png" alt="Foto Santri" class="foto-profil-santri">
    ...
    <div id="modalTambahSantri" class="modal-overlay">
        <div class="modal-content" style="max-height: 90vh; overflow-y: auto;">
            ...
            <form action="../backend/simpan_santri.php" method="POST" enctype="multipart/form-data">
    ...
    <script src="../public/js/admin-santri.js"></script>
    <!-- Sweet Alert -->
